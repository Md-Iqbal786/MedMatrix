      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2" data-purpose="brand-logo">
            <div className="w-10 h-10 bg-medcare-primary rounded-lg flex items-center justify-center">
              <svg
            ...
            <span className="text-2xl font-bold tracking-tight text-medcare-primary">
              MedCare
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            <a
              className="text-slate-600 hover:text-medcare-primary font-medium transition-colors"
              href="#features"
            >
              Features
            </a>
          ...
          <div className="flex items-center gap-4">
            <button
              className="px-5 py-2 text-medcare-primary font-semibold hover:bg-blue-50 rounded-lg transition-all"
              data-purpose="login-button"
            >
              Login
            </button>
            <button
              className="px-6 py-2.5 bg-medcare-primary text-white font-semibold rounded-lg hover:bg-blue-800 shadow-md hover:shadow-lg transition-all"
